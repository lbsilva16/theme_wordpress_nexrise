...
<section id="care-plans" class="nx-section nx-section--soft care-plans-modern" style="scroll-margin-top: 96px;">
				...
				<div class="pricing-grid">
					<div class="pricing-card">
						...
						<div class="plan-price">
							<span class="starting-at"><?php esc_html_e( 'STARTING AT', 'nw-avada-like' ); ?></span>
							<div class="price-row">
								<span class="currency"><?php esc_html_e( '$', 'nw-avada-like' ); ?></span>
								<span><?php esc_html_e( '490', 'nw-avada-like' ); ?></span>
								<span class="currency-usd"><?php esc_html_e( 'USD', 'nw-avada-like' ); ?></span>
							</div>
							<span class="period"><?php esc_html_e( '(or local equivalent)', 'nw-avada-like' ); ?></span>
						</div>
					...
					<div class="pricing-card featured">
						...
						<div class="plan-price">
							...
							<div class="price-row">
								<span class="currency"><?php esc_html_e( '$', 'nw-avada-like' ); ?></span>
								<span><?php esc_html_e( '690', 'nw-avada-like' ); ?></span>
								<span class="currency-usd"><?php esc_html_e( 'USD', 'nw-avada-like' ); ?></span>
							</div>
							<span class="period"><?php esc_html_e( '(or local equivalent)', 'nw-avada-like' ); ?></span>
						</div>
					...
					<div class="pricing-card">
						...
						<div class="plan-price">
							...
							<div class="price-row">
								<span class="currency"><?php esc_html_e( '$', 'nw-avada-like' ); ?></span>
								<span><?php esc_html_e( '890', 'nw-avada-like' ); ?></span>
								<span class="currency-usd"><?php esc_html_e( 'USD', 'nw-avada-like' ); ?></span>
							</div>
							<span class="period"><?php esc_html_e( '(or local equivalent)', 'nw-avada-like' ); ?></span>
						</div>
	...
	<style>
		...
		#care-plans .pricing-card .plan-price .starting-at {
			display: block;
			width: 100%;
		...
		#care-plans .pricing-card .plan-price .price-row {
			display: flex;
		...
		#care-plans .pricing-card .plan-price .currency-usd {
		...
		#care-plans .pricing-card.featured .plan-price .starting-at,
		#care-plans .pricing-card.featured .plan-price .currency-usd,
		#care-plans .pricing-card.featured .plan-price .period {
			color: rgba(255, 255, 255, 0.85);
		}

		#care-plans .pricing-card.featured .plan-price .price-row {
			color: #ffffff;
		}
