    ...
    <div class="nexrise-footer__grid">
      <div class="nexrise-footer__brand">
        ...
        <div class="nexrise-footer__contact-info">
          ...
          <div class="nexrise-footer__contact-item nexrise-footer__contact-item--address">
            <span class="nexrise-footer__contact-label">Address:</span>
            <ul class="nexrise-footer__address-list">
              <li class="nexrise-footer__address-item">
                <svg class="nexrise-footer__address-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" fill="currentColor"/>
                </svg>
                <span class="nexrise-footer__address-text">Texas, USA</span>
              </li>
              <li class="nexrise-footer__address-item">
                <svg class="nexrise-footer__address-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" fill="currentColor"/>
                </svg>
                <span class="nexrise-footer__address-text">London, United Kingdom</span>
              </li>
              <li class="nexrise-footer__address-item">
                <svg class="nexrise-footer__address-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" fill="currentColor"/>
                </svg>
                <span class="nexrise-footer__address-text">Rio Grande do Sul, Brazil</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="nexrise-footer__section">
        ...
        <ul class="nexrise-footer__menu">
          ...
          <li><a href="<?php echo esc_url( 'https://gonexrise.com/privacy-policy/' ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Privacy Policy', 'nw-avada-like' ); ?></a></li>
        </ul>
      </div>
